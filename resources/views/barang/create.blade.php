    ...
    <div class="col-12 col-lg-9">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <img src="{{ asset('logo.png') }}" alt="Logo" class="rounded" style="height: 48px; width: auto; object-fit: contain;">
                
                <div>
                    <h4 class="fw-bold mb-1">Tambah Barang Baru</h4>
                    <p class="text-muted small mb-0">Lengkapi formulir di bawah ini untuk menambahkan aset inventaris baru.</p>
                </div>
            </div>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" name="kode_barang" id="kode_barang" 
                                   ...
                                   value="{{ old('kode_barang', $defaultKode) }}" required>
                            @error('kode_barang')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">Format kode unik (contoh: BRG-26-001).</small>
                        </div>
                        ...
                        <div class="col-6 col-md-4">
                            ...
                            <input type="number" name="stok" id="stok" min="0" 
                                   ...
                                   placeholder="0" value="{{ old('stok', 1) }}" required>
                            @error('stok')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-6 col-md-4">
                            ...
                            <input type="text" name="satuan" id="satuan" list="satuan-options" 
                                   ...
                                   placeholder="Pcs / Unit / Box" value="{{ old('satuan', 'Pcs') }}" required>
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="harga_satuan" id="harga_satuan" min="0" step="100" 
                                       ...
                                       placeholder="0" value="{{ old('harga_satuan', 0) }}" required>
                            </div>
                            @error('harga_satuan')
                        ...
                        <!-- Kondisi Barang -->
                        <div class="col-12 col-md-6">
                            <label class="form-label fw-semibold d-block">Kondisi Barang <span class="text-danger">*</span></label>
                            <div class="d-flex gap-3 pt-1">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kondisi" id="kondisi_baik" value="Baik" {{ old('kondisi', 'Baik') == 'Baik' ? 'checked' : '' }}>
                                    <label class="form-check-label text-success fw-semibold" for="kondisi_baik">
                                        <i class="bi bi-check-circle me-1"></i> Baik
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kondisi" id="kondisi_rusak_ringan" value="Rusak Ringan" {{ old('kondisi') == 'Rusak Ringan' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kondisi" id="kondisi_perlu_perbaikan" value="Perlu Perbaikan" {{ old('kondisi') == 'Perlu Perbaikan' ? 'checked' : '' }}>
                                    <label class="form-check-label text-danger fw-semibold" for="kondisi_perlu_perbaikan">
                        ...
                        <!-- Upload Foto Barang -->
                        <div class="col-12 col-md-6">
                            <label for="gambar" class="form-label fw-semibold">Foto / Gambar Barang</label>
                            ...
                            <div class="mt-2" id="previewContainer" style="display: none;">
                                <img id="previewImg" src="#" alt="Preview" class="img-thumbnail" style="max-height: 120px; object-fit: cover;">
                            </div>
                        </div>

                        <!-- Deskripsi / Spesifikasi -->
                        <div class="col-12">
                            <label for="deskripsi" class="form-label fw-semibold">Deskripsi / Spesifikasi Tambahan</label>
                            <textarea name="deskripsi" id="deskripsi" rows="3" 
                                      class="form-control @error('deskripsi') is-invalid @enderror" 
                                      placeholder="Tuliskan spesifikasi teknis, nomor seri, atau catatan penting...">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
